...
parser.add_argument('--net',type=str,default='uie')
...
parser.add_argument('--perloss',type=bool,default=False,help='perceptual loss')
parser.add_argument('--coralloss',type=bool,default=True,help='domain loss')
